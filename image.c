...
// 	p_vars->addr = mlx_get_data_addr(v.img, &bits_per_pixel, &size_line, &endian);

// 	dark_green = mlx_get_color_value(v.mlx, 0x00FFFFFF);

// 	for (int i = 0; i < (1200 * 800) * 4; i++)
// 	{
// 		if (i % 100 == 0)
// 			*((unsigned int *)(p_vars->addr + i)) = dark_green;
// 	}
